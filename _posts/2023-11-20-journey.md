---
layout: post
title: "Founders Blog #1 -- “AI Town” Deep Dive: the good, the bad, the ugly"
date: "2023-11-19"
listed: true
author: "Jiao Dong"
...
Welcome to the inaugural post of our Founder's Blog Series! I'm Jiao Dong (董骥骜), CEO and co-founder of Nuva Lab. An engineer passionate about AI / AI Infra, content creation, gaming, and consumer tech.
...
Fun fact: I almost quit my job at FB at the 1.5 year mark. The only thing that held me back was if I left, our Starcraft II team probably won’t make it to the playoffs. So I stayed for a few more months longer, we made it to the quarter finals, and at the end of the tournament I found the AI Infra org that I would love to join.

![Starcraft II](https://github.com/Nuva-Lab/Nuva-Lab.github.io/blob/main/assets/image/starcraft.jpg?raw=true "Starcraft II")
...
![Animal Crossing](https://github.com/Nuva-Lab/Nuva-Lab.github.io/blob/main/assets/image/animal_crossing.png?raw=true "Animal Crossing")
...
Meanwhile, my cofounder and I attended the GDC and Nvidia GTC conferences separately in March 2023. After comparing notes, we realized that the intersection of entertainment and AI is extremely underserved – everyone believed that modern AI will revolutionize entertainment, but no one seems to have a clear idea of exactly how.

This realization was exciting enough to prompt the start of a new journey.

## Initial Prototype v0 and v1

<iframe width="100%" height="600" src="https://www.youtube.com/watch?v=8WVv0XX3D0c" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
I also received intriguing validation from the RPGMaker forum. When I asked, "Hey guys, is there a component I can use to take user free inputs?" the response was, "**Why do you even need that?** " Because few people use the tool built around free text input and response as the core loop. You know you're onto something interesting when you hear a response like that.

It was just Vicuna-7B with GGML running on my laptop, **but it opened up a whole new world**.

<iframe width="100%" height="600" src="https://www.youtube.com/embed/DBQZrfOedD8" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
